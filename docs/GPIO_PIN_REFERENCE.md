...
| **MPU6050 SDA** | GPIO 21 | I2C Data | Bidirectional | Gyro/Accelerometer data |
| **MPU6050 SCL** | GPIO 22 | I2C Clock | Output | Gyro/Accelerometer clock |
...
- **Connection**:
  ```
  ESP32 GPIO 21 → MPU6050 SDA pin
  ```

#### 5. MPU6050 SCL - GPIO 22
...
1. Verify I2C connections (GPIO 21 = SDA, GPIO 22 = SCL)
...
1. Connect MPU6050 to I2C pins (GPIO 21/22)
2. Power cycle ESP32
3. Check serial monitor for "MPU6050 initialized!" message
4. If fails: System continues in degraded mode (manual control only)
